...
//>>demos: http://jqueryui.com/effect/
    ...
    var effectsEffectPulsate = $.effects.define("pulsate", "show", function (options, done) {
        var element = $(this), mode = options.mode, show = mode === "show", hide = mode === "hide",
            ...
            anims = ((options.times || 5) * 2) + (showhide ? 1 : 0), duration = options.duration / anims, animateTo = 0,
            i = 1, queuelen = element.queue().length;
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.checkboxradio", [$.ui.formResetMixin, {
        version: "1.12.1", options: {
            disabled: null, label: null, icon: true, classes: {
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _getPaddingPlusBorderDimensions: function (element) {
            ...
            return {
                height: widths[0] + widths[2], width: widths[1] + widths[3]
            };
        },
 ...
 */
    ...
    $.ui.plugin.add("resizable", "animate", {
        ...
        stop: function (event) {
            var that = $(this).resizable("instance"), o = that.options, pr = that._proportionallyResizeElements,
                ...
                soffsetw = ista ? 0 : that.sizeDiff.width, style = {
                    width: (that.size.width - soffsetw), height: (that.size.height - soffseth)
                },
                left = (parseFloat(that.element.css("left")) + (that.position.left - that.originalPosition.left)) || null,
                top = (parseFloat(that.element.css("top")) + (that.position.top - that.originalPosition.top)) || null;
    ...
    $.ui.plugin.add("resizable", "ghost", {
        ...
        resize: function () {
            ...
            if (that.ghost) {
                that.ghost.css({
                    position: "relative", height: that.size.height, width: that.size.width
                });
            }
        },
    ...
    $.widget("ui.dialog", {
        ...
        _createTitlebar: function () {
            ...
            this.uiDialogTitlebarClose = $("<button type='button'></button>")
                .button({
                    label: $("<a>").text(this.options.closeText).html(), icon: "ui-icon-closethick", showLabel: false
                })
        ...
        _createButtons: function () {
            ...
            $.each(buttons, function (name, props) {
                ...
                click = props.click;
                buttonOptions = {
                    icon: props.icon, iconPosition: props.iconPosition, showLabel: props.showLabel,

                    // Deprecated options
                    icons: props.icons, text: props.text
                };
        ...
        _makeDraggable: function () {
            ...
            function filteredUi(ui) {
                return {
                    position: ui.position, offset: ui.offset
                };
            }
        ...
        _size: function () {
            ...
            nonContentHeight = this.uiDialog.css({
                height: "auto", width: options.width
            })
                .outerHeight();
...
//>>demos: http://jqueryui.com/droppable/
    ...
    $.widget("ui.droppable", {
        version: "1.12.1", widgetEventPrefix: "drop", options: {
            accept: "*", addClasses: true, greedy: false, scope: "default", tolerance: "intersect",

            // Callbacks
            activate: null, deactivate: null, drop: null, out: null, over: null
        }, _create: function () {
        ...
        ui: function (c) {
            return {
                draggable: (c.currentItem || c.element), helper: c.helper, position: c.position, offset: c.positionAbs
            };
        },
...
// TODO: switch return back to widget declaration at top of file when this is removed
    if ($.uiBackCompat !== false) {
        ...
        $.widget("ui.droppable", $.ui.droppable, {
            options: {
                hoverClass: false, activeClass: false
            }, _addActiveClass: function () {
                this._super();
    ...
    var widgetsProgressbar = $.widget("ui.progressbar", {
        ...
        _refreshValue: function () {
            ...
            if (this.indeterminate) {
                ...
                this.element.attr({
                    "aria-valuemax": this.options.max, "aria-valuenow": value
                });
                if (this.overlayDiv) {
...
//>>css.structure: ../../themes/base/selectable.css
    ...
    var widgetsSelectable = $.widget("ui.selectable", $.ui.mouse, {
        version: "1.12.1", options: {
            ...
            // Callbacks
            selected: null, selecting: null, start: null, stop: null, unselected: null, unselecting: null
        }, _create: function () {
            var that = this;
            ...
            this.refresh = function () {
                ...
                that.selectees.each(function () {
                    var $this = $(this), selecteeOffset = $this.offset(), pos = {
                        left: selecteeOffset.left - that.elementPos.left, top: selecteeOffset.top - that.elementPos.top
                    };
        ...
        _mouseStart: function (event) {
            ...
            this.helper.css({
                "left": event.pageX, "top": event.pageY, "width": 0, "height": 0
            });
...
//>>css.theme: ../../themes/base/theme.css
    ...
    var widgetsSelectmenu = $.widget("ui.selectmenu", [$.ui.formResetMixin, {
        ...
        _create: function () {
            ...
            this.ids = {
                element: selectmenuId, button: selectmenuId + "-button", menu: selectmenuId + "-menu"
            };
        ...
        _drawMenu: function () {
            ...
            this.menuInstance = this.menu
                .menu({
                    ...
                    }, role: "listbox", select: function (event, ui) {
                        event.preventDefault();
        ...
        _setAria: function (item) {
            ...
            this.button.attr({
                "aria-labelledby": id, "aria-activedescendant": id
            });
...
//>>css.theme: ../../themes/base/theme.css
    ...
    var widgetsSlider = $.widget("ui.slider", $.ui.mouse, {
        version: "1.12.1", widgetEventPrefix: "slide",

        options: {
            animate: false, classes: {
                "ui-slider": "ui-corner-all", "ui-slider-handle": "ui-corner-all",

                // Note: ui-widget-header isn't the most fittingly semantic framework class for this
                // element, but worked best visually with a variety of themes
                "ui-slider-range": "ui-corner-all ui-widget-header"
            }, distance: 0, max: 100, min: 0, orientation: "horizontal", range: false, step: 1, value: 0, values: null,
        ...
        _uiHash: function (index, value, values) {
            var uiHash = {
                handle: this.handles[index], handleIndex: index, value: value !== undefined ? value : this.value()
            };
...
//>>css.structure: ../../themes/base/sortable.css
    ...
    var widgetsSortable = $.widget("ui.sortable", $.ui.mouse, {
        version: "1.12.1", widgetEventPrefix: "sort", ready: false, options: {
            appendTo: "parent",
            axis: false,
            connectWith: false,
            containment: false,
        ...
        _getItemsAsjQuery: function (connected) {
            ...
            queries.push([$.isFunction(this.options.items) ? this.options.items
                    ...
                    for (j = cur.length - 1; j >= 0; j--) {
                        ...
                        if (inst && inst !== this && !inst.options.disabled) {
                            queries.push([$.isFunction(inst.options.items) ? inst.options.items
                                .call(inst.element[0], event, {item: this.currentItem}) : $(inst.options.items, inst.element), inst]);
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.spinner", {
        version: "1.12.1", defaultElement: "<input>", widgetEventPrefix: "spin", options: {
            classes: {
                "ui-spinner": "ui-corner-all", "ui-spinner-down": "ui-corner-br", "ui-spinner-up": "ui-corner-tr"
            }, culture: null, icons: {
                down: "ui-icon-triangle-1-s", up: "ui-icon-triangle-1-n"
            }, incremental: true, max: null, min: null, numberFormat: null, page: 10, step: 1,
        ...
        _draw: function () {
            ...
            this.buttons.first().button({
                "icon": this.options.icons.up, "showLabel": false
            });
            this.buttons.last().button({
                "icon": this.options.icons.down, "showLabel": false
            });
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.tabs", {
        version: "1.12.1", delay: 300, options: {
            ...
            }, collapsible: false, event: "click", heightStyle: "content", hide: null, show: null,
        ...
        _getCreateEventData: function () {
            return {
                tab: this.active, panel: !this.active.length ? $() : this._getPanelForTab(this.active)
            };
        },
        ...
        _processTabs: function () {
            ...
            this.anchors.each(function (i, anchor) {
                ...
                tab.attr({
                    "aria-controls": panelId, "aria-labelledby": anchorId
                });
        ...
        _eventHandler: function (event) {
            var options = this.options, active = this.active, anchor = $(event.currentTarget),
                ...
                toHide = !active.length ? $() : this._getPanelForTab(active), eventData = {
                    oldTab: active, oldPanel: toHide, newTab: collapsing ? $() : tab, newPanel: toShow
                };
...
//>>css.theme: ../../themes/base/theme.css
    ...
    $.widget("ui.tooltip", {
        version: "1.12.1", options: {
            ...
            items: "[title]:not([disabled])", position: {
                my: "left top+15", at: "left bottom", collision: "flipfit flip"
            }, show: true, track: false,
                ...
                target.parents().each(function () {
                    ...
                    if (parent.attr("title")) {
                        ...
                        that.parents[this.id] = {
                            element: this, title: parent.attr("title")
                        };
                        parent.attr("title", "");
                    }
                });
        ...
        _tooltip: function (element) {
            ...
            return this.tooltips[id] = {
                element: element, tooltip: tooltip
            };
        },
