<div class="list">
    ...
    <div class="action">
        <span onclick="AnswerMessage(<?= $data['is_login']; ?>, <?= $data['id']; ?>, <?= $data['parent_id']; ?>);"
              class="ui-icon ui-icon-comment tooltip" title="Ответить на сообщение"></span>
        <span onclick="EditMessage(<?= $data['is_login']; ?>, <?= $data['id']; ?>, <?= $data['parent_id']; ?>);"
              class="ui-icon ui-icon-pencil tooltip" title="Редактировать сообщение"></span>
